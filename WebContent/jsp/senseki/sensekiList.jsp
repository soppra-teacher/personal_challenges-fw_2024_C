		...
		<html:form action="/SensekiListDisp" focus="sensekiNm">
			...
			<div class="contents block-center">
				...
				<table class="layout-table block-center w-auto">
					...
					<td class="text-left l-shushi-shunyu"><span class="p-10">
							<h1>
						...
						<logic:notEmpty name="viewBean" property="list">
							<logic:iterate id="list" name="viewBean" property="list">
								<tr>
									...
									<td class="l-senseki-match-date "><bean:write name="list"
											property="matchDate" /></td>
									<td class="l-senseki-e-team"><bean:write name="list"
											property="eTeam" /></td>
									<td class="text-center"><span class="p-10"> <bean:write
												name="list" property="inning" />
									</span>
									<td class="text-center"><span class="p-10"> <bean:write
												name="list" property="tamakazu" />
									</span></td>
									<td class="text-center"><bean:write name="list"
											property="hianda" /></td>
									<td class="text-center"><bean:write name="list"
											property="yoshikyu" /></td>
									<td class="text-center"><bean:write name="list"
											property="datsusanshin" /></td>
									<td class="text-center"><bean:write name="list"
											property="sittenNm" /></td>
									<td class="text-center"><bean:write name="list"
											property="jisekitenNm" /></td>
									<td class="text-center"><input type="checkbox"
										name="checkDel"
										value="<bean:write name="list" property="matchId" />" /></td>
								</tr>
							</logic:iterate>
						</logic:notEmpty>
					</table>
