...
<body onload="setDeleteButton();">
	...
	<bean:define id="inputBean" name="shushiListSetaiForm" />
	<bean:define id="viewBean" name="SHUSHI_LIST_SETAI_DTO" />

	<div class="base-width text-center">

		<html:form action="/ShushiListSetaiDisp" focus="yearKey">

			<jsp:include page="/jsp/common/header.jsp">
				<jsp:param name="screenTitle" value="収支一覧（世帯）"/>
			</jsp:include>
			...
			<div class="contents">
				...
				<table class="layout-table w-100">
					...
					<tr>
						<td class="w-50 text-left">
							...
							<html:select name="inputBean" property="kojinNmKey" styleClass="input-select-xl" >
								<html:optionsCollection name="viewBean" property="kojinNm" value="key" label="value" />
							</html:select>
						</td>
				...
				<table class="l-shushi table mb-0" >
					<tr class="table-header">
						...
						<td class="l-shushi-kojin-nm">個人名</td>
						<td colspan="2">費目名</td>
						...
						<logic:notEmpty name="viewBean" property="list">
							<logic:iterate id="list" name="viewBean" property="list">
								<tr>
									...
									<td class="text-left l-shushi-kojin-nm">
										<span class="p-10">
