...
public class SensekiRegServiceImpl implements SensekiRegService {
	...
	public SensekiListDto listSearch(Map<String, Object> formMap,LoginDto loginDto) {
		...
		result.setPlayerNm(sensekiRegDao.getPlayerName(formMap));
		...
		// 検索処理
		List<Map<String, String>> list = sensekiRegDao.searchSenseki(formMap,loginDto);
	...
	public void listDelete(Map<String, Object> formMap, LoginDto loginDto) {
		...
		for (String checkDel : list) {
			sensekiRegDao.deleteSenseki(checkDel, loginDto);
		}
	}
